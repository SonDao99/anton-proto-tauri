          ...
          >
            ...
            >
              <Button
                ref={handleRef}
                variant="ghost"
                className="absolute -left-0 h-6 w-full p-0 cursor-grab hover:cursor-grabbing"
...
function Gutter({
  ...
  return (
    <div
      ...
      className={cn(
        "slate-gutterLeft",
        "absolute top-0 z-50 flex h-full -translate-x-full cursor-grab hover:opacity-100 sm:opacity-0",
        getPluginByType(editor, element.type)?.node.isContainer
